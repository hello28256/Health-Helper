...
class DevicesApi {
  ...
  Future<Response<void>> apiDevicesDeviceIdDelete({ 
    ...
    final _path = r'/api/devices/{deviceId}'.replaceAll('{' r'deviceId' '}', encodeQueryParameter(_serializers, deviceId, const FullType(String)).toString());
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<DeviceToken>> apiDevicesPost({ 
    required ApiDevicesPostRequest apiDevicesPostRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(ApiDevicesPostRequest);
      _bodyData = _serializers.serialize(apiDevicesPostRequest, specifiedType: _type);
